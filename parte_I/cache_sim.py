...
# Se a;ade el directorio de traces directorio de traces
options.TRACE_FILE = "./traces/{}.gz".format(options.TRACE_FILE)  

cache = cache(int(options.cache_capacity), int(options.cache_assoc), int(options.block_size), options.repl_policy)
